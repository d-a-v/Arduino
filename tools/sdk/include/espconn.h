 ...
 *               ipaddr -- pointer to an ip_addr_v4_t containing the IP address of
...
typedef void (*dns_found_callback)(const char *name, ip_addr_v4_t *ipaddr, void *callback_arg);
 ...
 *                addr -- pointer to a ip_addr_v4_t where to store the address if 
...
err_t espconn_gethostbyname(struct espconn *pespconn, const char *hostname, ip_addr_v4_t *addr, dns_found_callback found);
 ...
 * Returns      : none
*******************************************************************************/
sint8 espconn_igmp_join(ip_addr_v4_t *host_ip, ip_addr_v4_t *multicast_ip);
 ...
 * Returns      : none
*******************************************************************************/
sint8 espconn_igmp_leave(ip_addr_v4_t *host_ip, ip_addr_v4_t *multicast_ip);
 ...
 *  Returns     : none
*******************************************************************************/
void espconn_dns_setserver(char numdns, ip_addr_v4_t *dnsserver);
