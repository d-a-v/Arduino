...
namespace esp8266webserverLegacy {
...
#include "ESP8266WebServerLegacy-impl.h"
#include "ParsingLegacy-impl.h"

};


using ESP8266WebServer = esp8266webserverLegacy::ESP8266WebServerTemplate<WiFiServer>;
using RequestHandler = esp8266webserverLegacy::RequestHandler<WiFiServer>;
